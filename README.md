...
<p align="center">
  🔍 Currently looking for <b>Summer 2027 internships</b> in ML/AI engineering &amp; applied research
</p>
...
- 🧠 **Neuroadaptive AI** — real-time EEG → engagement scoring → adaptive LLM behavior
- ⚡ **Energy-efficient deep learning** — benchmarking spiking neural networks against standard ANN baselines on EEG decoding
- 📐 **ML fundamentals from scratch** — implementing core algorithms in raw NumPy before reaching for the library
- 🛠️ **Systems &amp; software engineering** — C++, OOP design, simulation logic
...
**[Learning Machine Learning](https://github.com/AdityaJain-0/Learning-Machine-Learning)** — Core supervised and unsupervised ML algorithms (linear/logistic regression, SVM, random forest, gradient boosting, k-means, DBSCAN, and more) implemented from scratch in NumPy, paired with hand-written derivations of the underlying math and applied scikit-learn examples.
